...
| Поле | Значення |
| --- | --- |
| Прізвище та ім'я |Андрощук Роман|
| GitHub-логін |neRoma32|
| Підгрупа |КН-41|
| Тема проєкту |Сервіс бронювання аудиторій і обладнання з погодженням заявок|
| Варіант вхідних умов |V01|
| Трекер | посилання |
| Дошка | посилання |
